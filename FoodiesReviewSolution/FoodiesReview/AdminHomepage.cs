...
namespace FoodiesReview
{
    ...
    {
        SearchResultDelegate searchDel;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            addRestaurant.Closed += (s, args) => this.Close();
            addRestaurant.Show();
        }

        //Go to DeleteRestaurant
        private void button5_Click(object sender, EventArgs e)
        {
            DeleteRestaurant deleteRestaurant = new DeleteRestaurant();
            this.Hide();
            deleteRestaurant.Closed += (s, args) => this.Close();
        ...
        private void listBox1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (listBox1.SelectedItem != null)
            {
                if (listBox1.SelectedItem.ToString().Length != 0)
                {
                    ...
                    name = words[0];
                    location = words[1];
                    ItemInterface itemInterface = new ItemInterface(name, location, "AD");
                    this.Hide();
